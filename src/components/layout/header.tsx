  ...
  return (
    <>
      ...
      >
        ...
        <div className="lg:max-w-6xl xl:max-w-[1440px] duration-500 sm:mx-auto bg-white/95 backdrop-blur-lg md:backdrop-blur-none shadow-lg md:shadow-none md:bg-transparent rounded-lg md:rounded-none py-3.5 md:py-6 md:px-5">
